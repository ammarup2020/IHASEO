...
public class Plan_User extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.plan_user);
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if (snapshot.exists()) {
                    ...
                    for (DataSnapshot daySnapshot : snapshot.getChildren()) {
                        ...
                        TextView dayTextView = new TextView(Plan_User.this);
                        ...
                        for (DataSnapshot itemSnapshot : daySnapshot.getChildren()) {
                            ...
                            TextView itemTextView = new TextView(Plan_User.this);
                            ...
                            View lineView = new View(Plan_User.this);
                            LayoutParams lineLayoutParams = new LayoutParams(LayoutParams.MATCH_PARENT, 2); // Adjust the height of the line as needed
        ...
        homeImageView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                startActivity(new Intent(Plan_User.this, Dashboard.class));
        ...
        roomImageView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                startActivity(new Intent(Plan_User.this, User_Rooms.class));
            }
        });
    }
}
