...
public class user_Bath_appliance extends AppCompatActivity {

    private ToggleButton lightToggle, fanToggle;

    private BroadcastReceiver lightOnReceiver, lightOffReceiver;
    private BroadcastReceiver fanOnReceiver, fanOffReceiver;
    private SharedPreferences lightStatePrefbath;
    private SharedPreferences fanStatePrefbath;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_user_bath_appliance);

        lightToggle = findViewById(R.id.light_toggle_bath);
        fanToggle = findViewById(R.id.fan_toggle_bath);
        ...
        boolean isLightOn = lightStatePrefbath.getBoolean(User_Dashboard.LIGHT_STATE_PREF_KEY, true); // Access using MainActivity.class
        ...
        boolean isFanOn = fanStatePrefbath.getBoolean(User_Dashboard.FAN_STATE_PREF_KEY, true); // Access using MainActivity.class
        ...
        lightToggle.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(user_Bath_appliance.this, "Light Turned On", Toast.LENGTH_SHORT).show();
                } else {
                    System.out.println("Light turned off");
                    Toast.makeText(user_Bath_appliance.this, "Light Turned Off", Toast.LENGTH_SHORT).show();
                }
            }
        });
        ...
        fanToggle.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(user_Bath_appliance.this, "Fan Turned On", Toast.LENGTH_SHORT).show();
                } else {
                    System.out.println("Fan turned off");
                    Toast.makeText(user_Bath_appliance.this, "Fan Turned Off", Toast.LENGTH_SHORT).show();
                }
            }
        });
        ...
        homeImageView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                startActivity(new Intent(user_Bath_appliance.this, User_Dashboard.class));
        ...
        roomImageView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                startActivity(new Intent(user_Bath_appliance.this, User_Rooms.class));
            }
        });
    }
}