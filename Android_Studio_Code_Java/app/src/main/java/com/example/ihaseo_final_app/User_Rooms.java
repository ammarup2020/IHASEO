...
public class User_Rooms extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bedroom.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // Open rooms page
                startActivity(new Intent(User_Rooms.this, Appliance_1.class));
            }
        });
        ...
        livingroom.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(User_Rooms.this, Appliances.class));
            }
        });
        ...
        kitchen.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // Open rooms page
                startActivity(new Intent(User_Rooms.this, Kit_Appliance.class));
            }
        });
        ...
        bathroom.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // Open rooms page
                startActivity(new Intent(User_Rooms.this, Bath_appliance.class));
            }
        });
        ...
        homeImageView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                startActivity(new Intent(User_Rooms.this, Dashboard.class));
        ...
        public void onClick(View v) {
        // Navigate to Dashboard activity (Refresh dashboard)
        startActivity(new Intent(User_Rooms.this, voice.class));
        finish(); // Close the current dashboard activity
        }
        });**/
        ...
        roomImageView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                startActivity(new Intent(User_Rooms.this, Rooms.class));
            }
        });
    }
