...
public class Kit_Appliance extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_kit_appliance);
        ...
        boolean isLightOn = lightStatePrefkit.getBoolean(Dashboard.LIGHT_STATE_PREF_KEY, true); // Access using MainActivity.class
        ...
        boolean isFanOn = fanStatePrefkit.getBoolean(Dashboard.FAN_STATE_PREF_KEY, true); // Access using MainActivity.class
        ...
        lightToggle.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(Kit_Appliance.this, "Light Turned On", Toast.LENGTH_SHORT).show();
                } else {
                    System.out.println("Light turned off");
                    Toast.makeText(Kit_Appliance.this, "Light Turned Off", Toast.LENGTH_SHORT).show();
                }
            }
        });
        ...
        fanToggle.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(Kit_Appliance.this, "Fan Turned On", Toast.LENGTH_SHORT).show();
                } else {
                    System.out.println("Fan turned off");
                    Toast.makeText(Kit_Appliance.this, "Fan Turned Off", Toast.LENGTH_SHORT).show();
                }
            }
        });
        ...
        moToggle.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(Kit_Appliance.this, "Microwave Oven Turned On", Toast.LENGTH_SHORT).show();
                } else {
                    System.out.println("Microwave Oven turned off");
                    Toast.makeText(Kit_Appliance.this, "Microwave Oven Turned Off", Toast.LENGTH_SHORT).show();
                }
            }
        });
        ...
        fridgeToggle.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(Kit_Appliance.this, "Fridge Turned On", Toast.LENGTH_SHORT).show();
                } else {
                    System.out.println("TV turned off");
                    Toast.makeText(Kit_Appliance.this, "Fridge Turned Off", Toast.LENGTH_SHORT).show();
                }
            }
        });
        ...
        homeImageView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                startActivity(new Intent(Kit_Appliance.this, Dashboard.class));
        ...
        roomImageView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                startActivity(new Intent(Kit_Appliance.this, Rooms.class));
            }
        });
    }
}