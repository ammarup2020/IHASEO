...
public class user_appliances extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_user_appliances);
        ...
        boolean isLightOn = lightStatePreflr.getBoolean(User_Dashboard.LIGHT_STATE_PREF_KEY, true); // Access using MainActivity.class
        ...
        boolean isFanOn = fanStatePreflr.getBoolean(User_Dashboard.FAN_STATE_PREF_KEY, true); // Access using MainActivity.class
        ...
        lightToggle.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(user_appliances.this, "Light Turned On", Toast.LENGTH_SHORT).show();
                } else {
                    System.out.println("Light turned off");
                    Toast.makeText(user_appliances.this, "Light Turned Off", Toast.LENGTH_SHORT).show();
                }
            }
        });
        ...
        fanToggle.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(user_appliances.this, "Fan Turned On", Toast.LENGTH_SHORT).show();
                } else {
                    System.out.println("Fan turned off");
                    Toast.makeText(user_appliances.this, "Fan Turned Off", Toast.LENGTH_SHORT).show();
                }
            }
        });
        ...
        acToggle.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(user_appliances.this, "AC Turned On", Toast.LENGTH_SHORT).show();
                } else {
                    System.out.println("AC turned off");
                    Toast.makeText(user_appliances.this, "AC Turned Off", Toast.LENGTH_SHORT).show();
                }
            }
        });
        ...
        tvToggle.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(user_appliances.this, "TV Turned On", Toast.LENGTH_SHORT).show();
                } else {
                    System.out.println("TV turned off");
                    Toast.makeText(user_appliances.this, "TV Turned Off", Toast.LENGTH_SHORT).show();
                }
            }
        });
        ...
        ironToggle.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(user_appliances.this, "Iron Turned On", Toast.LENGTH_SHORT).show();
                } else {
                    System.out.println("Iron turned off");
                    Toast.makeText(user_appliances.this, "Iron Turned Off", Toast.LENGTH_SHORT).show();
                }
            }
        });
        ...
        w_mToggle.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(user_appliances.this, "Washing Machine Turned On", Toast.LENGTH_SHORT).show();
                } else {
                    System.out.println("Washing Machine turned off");
                    Toast.makeText(user_appliances.this, "Washing Machine Turned Off", Toast.LENGTH_SHORT).show();
                }
            }
        });
        ...
        homeImageView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                startActivity(new Intent(user_appliances.this, User_Dashboard.class));
        ...
        public void onClick(View v) {
        // Navigate to Dashboard activity (Refresh dashboard)
        startActivity(new Intent(user_appliances.this, voice.class));
        finish(); // Close the current dashboard activity
        }
        });**/
        ...
        roomImageView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                startActivity(new Intent(user_appliances.this, User_Rooms.class));
            }
        });
    }
}