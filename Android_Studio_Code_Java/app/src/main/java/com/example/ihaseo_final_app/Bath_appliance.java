...
public class Bath_appliance extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bath_appliance);
        ...
        boolean isLightOn = lightStatePrefbath.getBoolean(Dashboard.LIGHT_STATE_PREF_KEY, true); // Access using MainActivity.class
        ...
        boolean isFanOn = fanStatePrefbath.getBoolean(Dashboard.FAN_STATE_PREF_KEY, true); // Access using MainActivity.class
        ...
        lightToggle.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(Bath_appliance.this, "Light Turned On", Toast.LENGTH_SHORT).show();
                } else {
                    System.out.println("Light turned off");
                    Toast.makeText(Bath_appliance.this, "Light Turned Off", Toast.LENGTH_SHORT).show();
                }
            }
        });
        ...
        fanToggle.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(Bath_appliance.this, "Fan Turned On", Toast.LENGTH_SHORT).show();
                } else {
                    System.out.println("Fan turned off");
                    Toast.makeText(Bath_appliance.this, "Fan Turned Off", Toast.LENGTH_SHORT).show();
                }
            }
        });
        ...
        homeImageView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                startActivity(new Intent(Bath_appliance.this, Dashboard.class));
        ...
        roomImageView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                startActivity(new Intent(Bath_appliance.this, Rooms.class));
            }
        });
    }
}