...
public class User_Dashboard extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        roomsTextView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // Open rooms page
                startActivity(new Intent(User_Dashboard.this, User_Rooms.class));
            }
        });
        ...
        public void onClick(View v) {
        // Open rooms page
        startActivity(new Intent(User_Dashboard.this, Plan.class));
        }
        });**/
        ...
        settingsTextView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // Open settings page
                startActivity(new Intent(User_Dashboard.this, Setting.class));
            }
        });
        ...
        feedbackTextView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // Open feedback page
                startActivity(new Intent(User_Dashboard.this, Feedback.class));
            }
        });
        TextView planTextView = findViewById(R.id.planTextView);
        planTextView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                startActivity(new Intent(User_Dashboard.this, Plan_User.class));
        ...
        logoutTextView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                startActivity(new Intent(User_Dashboard.this,Signin.class));
                finish();
            }
        });
        ...
        public void onClick(View v) {
        // Navigate to Dashboard activity (Refresh dashboard)
        startActivity(new Intent(User_Dashboard.this, voice.class));
        finish(); // Close the current dashboard activity
        }
        });**/
    ...
    private void processVoiceCommand(String spokenText) {
        ...
        {
            Intent intent = new Intent(this, User_Feedback.class);
        ...
        {
            Intent intent = new Intent(this, Plan_User.class);
            startActivity(intent);
        }
        else if (spokenText.contains("open room"))
        {
            Intent intent = new Intent(this, User_Rooms.class);
            startActivity(intent);
        }
        //else if (spokenText.contains("open profile"))
        //{
        //    Intent intent = new Intent(this, ContactsContract.User_Profile.class);
        //    startActivity(intent);
        //}
