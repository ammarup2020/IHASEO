...
public class Appliance_1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_appliance1);
        ...
        boolean isLightOn = lightStatePref.getBoolean(Dashboard.LIGHT_STATE_PREF_KEY, true); // Access using MainActivity.class
        ...
        boolean isFanOn = fanStatePref.getBoolean(Dashboard.FAN_STATE_PREF_KEY, true); // Access using MainActivity.class
        ...
        lightToggle.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(Appliance_1.this, "Light Turned On", Toast.LENGTH_SHORT).show();
                } else {
                    System.out.println("Light turned off");
                    Toast.makeText(Appliance_1.this, "Light Turned Off", Toast.LENGTH_SHORT).show();
                }
            }
        });
        ...
        fanToggle.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(Appliance_1.this, "Fan Turned On", Toast.LENGTH_SHORT).show();
                } else {
                    System.out.println("Fan turned off");
                    Toast.makeText(Appliance_1.this, "Fan Turned Off", Toast.LENGTH_SHORT).show();
                }
            }
        });
        ...
        acToggle.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(Appliance_1.this, "AC Turned On", Toast.LENGTH_SHORT).show();
                } else {
                    System.out.println("AC turned off");
                    Toast.makeText(Appliance_1.this, "AC Turned Off", Toast.LENGTH_SHORT).show();
                }
            }
        });
        ...
        tvToggle.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(Appliance_1.this, "TV Turned On", Toast.LENGTH_SHORT).show();
                } else {
                    System.out.println("TV turned off");
                    Toast.makeText(Appliance_1.this, "TV Turned Off", Toast.LENGTH_SHORT).show();
                }
            }
        });
        ...
        homeImageView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                startActivity(new Intent(Appliance_1.this, Dashboard.class));
        ...
        roomImageView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                startActivity(new Intent(Appliance_1.this, Rooms.class));
            }
        });
    }
}